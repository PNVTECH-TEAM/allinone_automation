...
WebUI.setText(findTestObject('Object Repository/Login_Function/txt_Password'), 'Wrong@123')

WebUI.click(findTestObject('Object Repository/Login_Function/btn_Login'))

WebUI.verifyElementVisible(findTestObject('Object Repository/Login_Function/msg_LoginFailed'))
