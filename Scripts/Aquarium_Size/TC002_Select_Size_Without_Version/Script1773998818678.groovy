...
WebUI.click(findTestObject('Object Repository/Aquarium_Size/btn_ExtraLargeSize'))
...
WebUI.verifyElementText(findTestObject('Object Repository/Aquarium_Size/msg_NoDesignVersion'), 'No designs found for this size yet.')

// Close design version modal
WebUI.click(findTestObject('Object Repository/Aquarium_Size/btn_CloseDesignVersion'))
